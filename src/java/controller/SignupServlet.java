	...
	protected void doPost(HttpServletRequest request,
		...
		if (username.equals("") || password.equals("") || email.equals("") || diachi.equals("") || sdt.equals("")) {
                    ...
                    if (userDAO.checkUser(username, email) == true ) {
                        ...
                        final String email_check = "ducpb07101999@gmail.com";
                        final String password_check = "kbsnetone1";
                        ...
                        try {
                            ...
                            message.setFrom(new InternetAddress("ducpb07101999@gmail.com"));
                            message.setRecipients(
                                Message.RecipientType.TO,
                                InternetAddress.parse(email)
                            );               
                            message.setSubject("Register Successful!");
                            String text ="<i>Cám ơn bạn đã sử dụng dịch vụ của chúng tôi!</i><br/>";            
